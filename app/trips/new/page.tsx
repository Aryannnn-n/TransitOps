      ...
      <div className="flex items-center justify-center p-6 min-h-[50vh]">
        <div className="max-w-md w-full rounded-lg border border-zinc-200 bg-white p-6 text-center space-y-4 shadow-sm">
          ...
          <div className="pt-2">
            <Link 
              href="/"
              className="inline-flex rounded-md bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2 text-sm font-semibold cursor-pointer transition-colors"
            >
              Back to Dashboard
            </Link>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-zinc-650 font-medium">Select an available vehicle and driver to configure a new delivery trip.</p>
        </div>
